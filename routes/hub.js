...
router.patch("/user/:id/update", user_controller.patch_update_user);

// PROJECT
router.get("/user/:id/projects", project_controller.projects_list);
...
router.patch(
  ...
  project_controller.patch_update_project
);
...
router.patch(
  "/chapter/:chapter_id/update",
  chapter_controller.patch_update_chapter
);
